...
printf "https://github.com/0x0Dx/dotfiles/blob/main/scripts/install/distros/gentoo/README.md\n"
...
# daifuku
x sudo cp ./scripts/install/distros/gentoo/keywords ./scripts/install/distros/gentoo/keywords-user
x sed -i "s/$/ ~${arch}/" ./scripts/install/distros/gentoo/keywords-user
v sudo cp ./scripts/install/distros/gentoo/keywords-user /etc/portage/package.accept_keywords/daifuku

########## IMPORT USEFLAGS
v sudo cp ./scripts/install/distros/gentoo/useflags /etc/portage/package.use/daifuku
v sudo sh -c 'cat ./scripts/install/distros/gentoo/additional-useflags >> /etc/portage/package.use/daifuku'
...
source ./scripts/install/distros/gentoo/import-local-pkgs.sh

########## INSTALL ILLOGICAL-IMPUSEL EBUILDS
for i in "${metapkgs[@]}"; do
	x sudo mkdir -p ${ebuild_dir}/app-misc/${i}
	v sudo cp ./scripts/install/distros/gentoo/${i}/${i}*.ebuild ${ebuild_dir}/app-misc/${i}/
