...
- This folder should reflect the equivalents of `/scripts/install/distros/arch/` but under Gentoo.
  - **When `/scripts/install/distros/arch/` is newer than this folder, an update on this folder is very likely needed.**
  - Useful link: [Commit history on scripts/install/distros/arch/](https://github.com/0x0Dx/dotfiles/commits/main/scripts/install/distros/arch)
