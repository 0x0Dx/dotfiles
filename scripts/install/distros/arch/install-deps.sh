...
metapkgs=(./scripts/install/distros/arch/daifuku-{audio,backlight,basic,fonts-themes,kde,portal,python,screencapture,toolkit,widgets})
metapkgs+=(./scripts/install/distros/arch/daifuku-hyprland)
metapkgs+=(./scripts/install/distros/arch/daifuku-microtex-git)
metapkgs+=(./scripts/install/distros/arch/daifuku-quickshell-git)
[[ -f /usr/share/icons/Bibata-Modern-Classic/index.theme ]] || metapkgs+=(./scripts/install/distros/arch/daifuku-bibata-modern-classic-bin)
