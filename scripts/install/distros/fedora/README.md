...
- This folder should reflect the equivalents of `/scripts/install/distros/arch/` but under Fedora.
  - **When `/scripts/install/distros/arch/` is newer than this folder, an update on this folder is very likely needed.**
  - Useful link: [Commit history on sdata/dist-arch/](https://github.com/end-4/dots-hyprland/commits/main/scripts/install/distros/arch)
