...
# CONFIG
# -------------------------
user_config="${REPO_ROOT}/scripts/install/distros/fedora/user_data.yaml"
rpmbuildroot="${REPO_ROOT}/cache/rpmbuild"
deps_data_file="${REPO_ROOT}/scripts/install/distros/fedora/feddeps.toml"
...
function install_RPMS() {
  ...
  x cp -r "${REPO_ROOT}/scripts/install/distros/fedora/SPECS" "$rpmbuildroot/"
