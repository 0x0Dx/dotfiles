...
- This folder should reflect the equivalents of `/packages/installer/distros/arch/` but under Gentoo.
  - **When `/packages/installer/distros/arch/` is newer than this folder, an update on this folder is very likely needed.**
  - Useful link: [Commit history on packages/installer/distros/arch/](https://github.com/0x0Dx/dotfiles/commits/main/packages/installer/distros/arch)
...
6. Loops through all daifuku ebuilds to digest and emerge them.
