...
- This folder should reflect the equivalents of `/packages/installer/distros/arch/` but under Fedora.
  - **When `/packages/installer/distros/arch/` is newer than this folder, an update on this folder is very likely needed.**
  - Useful link: [Commit history on sdata/dist-arch/](https://github.com/end-4/dots-hyprland/commits/main/packages/installer/distros/arch)
