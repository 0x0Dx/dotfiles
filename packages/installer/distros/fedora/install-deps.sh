...
# CONFIG
# -------------------------
user_config="${REPO_ROOT}/packages/installer/distros/fedora/user_data.yaml"
rpmbuildroot="${REPO_ROOT}/cache/rpmbuild"
deps_data_file="${REPO_ROOT}/packages/installer/distros/fedora/feddeps.toml"
...
function install_RPMS() {
  ...
  x cp -r "${REPO_ROOT}/packages/installer/distros/fedora/SPECS" "$rpmbuildroot/"
